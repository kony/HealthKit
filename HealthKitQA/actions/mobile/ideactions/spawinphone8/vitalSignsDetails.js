...
function updateVitalSigns(heartRateLevel, bodyTemperatureLevel, bloodPressureSystolicLevel, bloodPressureDiastolicLevel, respiratoryRateLevel) {
    ...
    if (indexOfDotInSys !== -1) bloodPressureSystolicLevel = bloodPressureSystolicLevel.substring(0, indexOfDotInSys + 2);
    var indexOfDotInDia = bloodPressureDiastolicLevel.indexOf(".");
    if (indexOfDotInDia !== -1) bloodPressureDiastolicLevel = bloodPressureDiastolicLevel.substring(0, indexOfDotInDia + 2);
...
function resultsHandlerVitalsigns(query, results, error) {
    ...
    if (results) {
        ...
        if (HKQuantityTypeIdentifierHeartRate == query.sampleType.identifier) {
            ...
            if (indexOfDot !== -1) bodyTemperatureLevel = bodyTemperatureLevel.substring(0, indexOfDot);
            ...
            if (indexOfDot !== -1) bloodPressureSystolicLevel = bloodPressureSystolicLevel.substring(0, indexOfDot);
            ...
            if (indexOfDot !== -1) bloodPressureDiastolicLevel = bloodPressureDiastolicLevel.substring(0, indexOfDot);
