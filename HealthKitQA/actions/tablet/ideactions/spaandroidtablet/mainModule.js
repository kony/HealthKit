...
function onRowClick_FrmHomeMenu(rowIndex) {
    ...
    if (selectedIndex == 0) body.show();
    else if (selectedIndex == 1) fitness.show();
    else if (selectedIndex == 2) vitalsigns.show();
    else if (selectedIndex == 3) results.show();
    else if (selectedIndex == 4) nutrition.show();
    else characteristics.show();
}
/*****************************************************************
 *	Name    : initAuthBody
 *	Author  : Kony
